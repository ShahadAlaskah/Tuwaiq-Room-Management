...
namespace Infrastructure.Persistence.Ef.Migrations
{
    ...
    [Migration("20230917144301_AddExamAdvancedOption")]
    partial class AddExamAdvancedOption
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Domains.ExamAdvancedOption", b =>
                {
                    b.HasOne("Domain.Domains.FormTemplate", "FormTemplate")
                        .WithOne("ExamAdvancedOption")
                        .HasForeignKey("Domain.Domains.ExamAdvancedOption", "FormTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
