...
namespace Infrastructure.Persistence.Ef.Migrations
{
    ...
    [Migration("20230918115224_FixExamAdvancedOptionRelation")]
    partial class FixExamAdvancedOptionRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Domains.ExamAdvancedOption", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");

                    b.Property<bool>("CanGoBack")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<int>("QuestionPerPage")
                        .HasColumnType("int");

                    b.Property<bool>("QuestionRandomize")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("RequireAuthentication")
                        .HasColumnType("tinyint(1)");

                    b.Property<TimeOnly?>("TimePerPage")
                        .HasColumnType("time(6)");

                    b.HasKey("Id");

                    b.ToTable("ExamAdvancedOptions", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Domains.FormTemplate", b =>
                {
                    ...
                    b.Property<Guid?>("ExamAdvancedOptionId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("ExamAdvancedOptionId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Domains.FormTemplate", b =>
                {
                    b.HasOne("Domain.Domains.ExamAdvancedOption", "ExamAdvancedOption")
                        .WithOne("FormTemplate")
                        .HasForeignKey("Domain.Domains.FormTemplate", "ExamAdvancedOptionId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("ExamAdvancedOption");
            ...
            modelBuilder.Entity("Domain.Domains.FormTemplateQuestion", b =>
                {
                    b.HasOne("Domain.Domains.FormTemplate", "FormTemplate")
